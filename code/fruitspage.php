...
<h1 class="w3-center"><b><i>Fruits Store</i></b></h1>
<div class="row">
...
<img class="card-img-top" src="apple.jpg" alt="Card image cap">
  <div class="card-block">
    ...
    <a href="#" data-name="Apple" data-price="175" class="add-to-cart btn btn-primary">Add to cart</a>
  </div>
</div>
...
<img class="card-img-top" src="orange.jpg" alt="Card image cap">
  <div class="card-block">
    ...
    <a href="#" data-name="Orange" data-price="170" class="add-to-cart btn btn-primary">Add to cart</a>
  </div>
...
<div class="card">
<img class="card-img-top" src="kiwi.jpg" alt="Card image cap">
  <div class="card-block">
    <h4 class="card-title">Kiwi</h4>
    <p class="card-text">Price: Rs.115</p>
    <a href="#" data-name="Kiwi" data-price="115" class="add-to-cart btn btn-primary">Add to cart</a>
  </div>
...
<div class="card">
<img class="card-img-top" src="watermelon.jpg" alt="Card image cap">
  <div class="card-block">
    <h4 class="card-title">Watermelon</h4>
    <p class="card-text">Price: Rs.50</p>
    <a href="#" data-name="Watermelon" data-price="50" class="add-to-cart btn btn-primary">Add to cart</a>
  </div>
...
<div class="card">
<img class="card-img-top" src="sweetlime.jpg" alt="Card image cap">
  <div class="card-block">
    <h4 class="card-title">SweetLime</h4>
    <p class="card-text">Price: Rs.70</p>
    <a href="#" data-name="SweetLime" data-price="70" class="add-to-cart btn btn-primary">Add to cart</a>
  </div>
...
<div class="card">
<img class="card-img-top" src="muskmelon.jpg" alt="Card image cap">
  <div class="card-block">
    <h4 class="card-title">Muskmelon</h4>
    <p class="card-text">Price: Rs.75</p>
    <a href="#" data-name="Muskmelon" data-price="75" class="add-to-cart btn btn-primary">Add to cart</a>
  </div>
...
<div class="card">
<img class="card-img-top" src="pomegranate.jpg" alt="Card image cap">
  <div class="card-block">
    <h4 class="card-title">Pomegranate</h4>
    <p class="card-text">Price: Rs.175</p>
    <a href="#" data-name="Pomegranate" data-price="175" class="add-to-cart btn btn-primary">Add to cart</a>
  </div>
...
<img class="card-img-top" src="banana.jpg" alt="Card image cap">
  <div class="card-block">
    ...
    <a href="#" data-name="Banana" data-price="55" class="add-to-cart btn btn-primary">Add to cart</a>
  </div>
