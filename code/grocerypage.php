...
<h1 class="w3-center"><b><i>Grocery Store</i></b></h1>
...
<div class="card">
<img class="card-img-top" src="chanadal.jpg" alt="Card image cap">
  <div class="card-block">
    <h4 class="card-title">Chana Dal</h4>
    <p class="card-text">Price: Rs.50</p>
    <a href="#" data-name="ChanaDal" data-price="50" class="add-to-cart btn btn-primary">Add to cart</a>
  </div>
</div>
...
<div class="card">
<img class="card-img-top" src="moongdal.jpg" alt="Card image cap">
  <div class="card-block">
    <h4 class="card-title">Moong Dal</h4>
    <p class="card-text">Price: Rs.90</p>
    <a href="#" data-name="MoongDal" data-price="90" class="add-to-cart btn btn-primary">Add to cart</a>
  </div>
...
<div class="card">
<img class="card-img-top" src="turdal.jpg" alt="Card image cap">
  <div class="card-block">
    <h4 class="card-title">Turdal</h4>
    <p class="card-text">Price: Rs.70</p>
    <a href="#" data-name="Turdal" data-price="70" class="add-to-cart btn btn-primary">Add to cart</a>
  </div>
...
<div class="card">
<img class="card-img-top" src="rajma.jpg" alt="Card image cap">
  <div class="card-block">
    <h4 class="card-title">Rajma</h4>
    <p class="card-text">Price: Rs.92</p>
    <a href="#" data-name="Rajma" data-price="92" class="add-to-cart btn btn-primary">Add to cart</a>
  </div>
...
<div class="card">
<img class="card-img-top" src="soyabean.jpg" alt="Card image cap">
  <div class="card-block">
    <h4 class="card-title">Soyabean</h4>
    <p class="card-text">Price: Rs.40</p>
    <a href="#" data-name="Soyabean" data-price="40" class="add-to-cart btn btn-primary">Add to cart</a>
  </div>
...
<div class="card">
<img class="card-img-top" src="masoor.jpg" alt="Card image cap">
  <div class="card-block">
    <h4 class="card-title">Masoor</h4>
    <p class="card-text">Price: Rs.70</p>
    <a href="#" data-name="Masoor" data-price="70" class="add-to-cart btn btn-primary">Add to cart</a>
  </div>
...
<div class="card">
<img class="card-img-top" src="poha.jpg" alt="Card image cap">
  <div class="card-block">
    <h4 class="card-title">Poha</h4>
    <p class="card-text">Price: Rs.40</p>
    <a href="#" data-name="Poha" data-price="40" class="add-to-cart btn btn-primary">Add to cart</a>
  </div>
...
<img class="card-img-top" src="sugar.jpg" alt="Card image cap">
  <div class="card-block">
    ...
    <a href="#" data-name="Sugar" data-price="115" class="add-to-cart btn btn-primary">Add to cart</a>
  </div>
