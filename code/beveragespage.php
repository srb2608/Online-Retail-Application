...
<h1 class="w3-center"><b><i>Beverages Store</i></b></h1>
<div class="row">

<div class="col3" ></div>

<div class="card">
<img class="card-img-top" src="sprite.jpg" alt="Card image cap">
  <div class="card-block">
    <h4 class="card-title">Sprite</h4>
    <p class="card-text">Price: Rs.65</p>
    <a href="#" data-name="Sprite" data-price="65" class="add-to-cart btn btn-primary">Add to cart</a>
  </div>
</div>
...
<div class="card">
<img class="card-img-top" src="appyfizz.jpg" alt="Card image cap">
  <div class="card-block">
    <h4 class="card-title">AppyFizz</h4>
    <p class="card-text">Price: Rs.80</p>
    <a href="#" data-name="AppyFizz" data-price="80" class="add-to-cart btn btn-primary">Add to cart</a>
  </div>
...
<div class="card">
<img class="card-img-top" src="redbull.jpg" alt="Card image cap">
  <div class="card-block">
    <h4 class="card-title">Redbull</h4>
    <p class="card-text">Price: Rs.390</p>
    <a href="#" data-name="Redbull" data-price="390" class="add-to-cart btn btn-primary">Add to cart</a>
  </div>
...
<div class="card">
<img class="card-img-top" src="tropicana.jpg" alt="Card image cap">
  <div class="card-block">
    <h4 class="card-title">Tropicana</h4>
    <p class="card-text">Price: Rs.66</p>
    <a href="#" data-name="Tropicana" data-price="66" class="add-to-cart btn btn-primary">Add to cart</a>
  </div>
...
<div class="card">
<img class="card-img-top" src="thumsup.jpg" alt="Card image cap">
  <div class="card-block">
    <h4 class="card-title">ThumpsUp</h4>
    <p class="card-text">Price: Rs.65</p>
    <a href="#" data-name="ThumpsUp" data-price="65" class="add-to-cart btn btn-primary">Add to cart</a>
  </div>
...
<div class="card">
<img class="card-img-top" src="roohafza.jpg" alt="Card image cap">
  <div class="card-block">
    <h4 class="card-title">RoohAfza</h4>
    <p class="card-text">Price: Rs.140</p>
    <a href="#" data-name="RoohAfza" data-price="140" class="add-to-cart btn btn-primary">Add to cart</a>
  </div>
...
<div class="card">
<img class="card-img-top" src="hersheys.jpg" alt="Card image cap">
  <div class="card-block">
    <h4 class="card-title">ChocolateSyrup</h4>
    <p class="card-text">Price: Rs.150</p>
    <a href="#" data-name="ChocolateSyrup" data-price="150" class="add-to-cart btn btn-primary">Add to cart</a>
  </div>
...
<div class="card">
<img class="card-img-top" src="maaza.jpg" alt="Card image cap">
  <div class="card-block">
    <h4 class="card-title">Maaza</h4>
    <p class="card-text">Price: Rs.60</p>
    <a href="#" data-name="Maaza" data-price="60" class="add-to-cart btn btn-primary">Add to cart</a>
  </div>
